...
This can be used to send the created ics file to another server to host it on an http connection for something like Home Assistant's `Remote Calendar` integration.
